...
//Undefined: Is a datatype that has been declared but there is no value that has been assigned to it.
let county;
console.log("The county is: ",county)

//Null data type: This is a datatype that contain null values
let username = null
